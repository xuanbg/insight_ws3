IF EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'SYS_WeiXin_Config') AND OBJECTPROPERTY(id, N'ISUSERTABLE') = 1)
DROP TABLE SYS_WeiXin_Config
GO

IF EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'BIZ_Pay_Record') AND OBJECTPROPERTY(id, N'ISUSERTABLE') = 1)
DROP TABLE BIZ_Pay_Record
GO
...
[SN]               BIGINT IDENTITY(1,1),                                                                                                   --自增序列
[UserType]         INT DEFAULT 0 NOT NULL,                                                                                                 --用户类型
...
[SN]               BIGINT IDENTITY(1,1),                                                                                                   --自增序列
[MemberId]         UNIQUEIDENTIFIER FOREIGN KEY REFERENCES MasterData(ID) ON DELETE CASCADE NOT NULL,                                      --会员ID
...
[SN]               BIGINT IDENTITY(1,1),                                                                                                   --自增序列
[MemberId]         UNIQUEIDENTIFIER FOREIGN KEY REFERENCES MasterData(ID) ON DELETE CASCADE NOT NULL,                                      --会员ID
[Name]             NVARCHAR(8),                                                                                                            --持卡人姓名
[Type]             NVARCHAR(4),                                                                                                            --卡类型
[BankName]         NVARCHAR(16),                                                                                                           --发卡银行
[Number]           VARCHAR(32),                                                                                                            --卡号
...
[Description]      NVARCHAR(MAX),                                                                                                          --描述
[Status]           INT DEFAULT 1 NOT NULL,                                                                                                 --状态：1、待处理；2、已回复；3、已解决；4、已归档
...
[SN]               BIGINT IDENTITY(1,1),                                                                                                   --自增序列
[MallId]           INT,                                                                                                                    --商城ID
[MallCode]         VARCHAR(8),                                                                                                             --商城代码
[MallName]         NVARCHAR(128),                                                                                                          --商城名称
...
[Interest]         DECIMAL(20,2) DEFAULT 0 NOT NULL,                                                                                       --月服务费
...
[YunOrderId]       INT,                                                                                                                    --云商订单ID
[XfbOrderId]       INT,                                                                                                                    --信分宝订单ID
[OutDate]          DATETIME,                                                                                                               --退货截至日期
[Description]      NVARCHAR(MAX),                                                                                                          --描述
[CancelTime]       DATETIME,                                                                                                               --取消时间
[RefundTime]       DATETIME,                                                                                                               --退款时间
[OrdersStatus]     INT,                                                                                                                    --云商订单状态
[DeliveryStatus]   INT,                                                                                                                    --云商物流状态
[PaymentStatus]    INT,                                                                                                                    --云商结算状态
[RefundStatus]     INT,                                                                                                                    --云商退款状态
)
GO
...
[ID]               UNIQUEIDENTIFIER CONSTRAINT IX_BIZ_Pay_Record PRIMARY KEY DEFAULT NEWSEQUENTIALID(),
[SN]               BIGINT IDENTITY(1,1),                                                                                                   --自增序列
[MemberId]         UNIQUEIDENTIFIER FOREIGN KEY REFERENCES MasterData(ID) ON DELETE CASCADE NOT NULL,                                      --会员ID
[Password]         VARCHAR(32) NOT NULL,                                                                                                   --密码（MD5）
[PayType]          INT NOT NULL,                                                                                                           --支付类型：1、微信；2、支付宝；3、银联
[Business]         INT NOT NULL,                                                                                                           --业务类型：1、首付款；2、账单还款
[TradeNo]          VARCHAR(64) NOT NULL,                                                                                                   --商户订单号
[Amount]           DECIMAL(20,2) DEFAULT 0 NOT NULL,                                                                                       --支付金额
[Description]      NVARCHAR(MAX),                                                                                                          --描述（相关业务ID）
[CreateTime]       DATETIME DEFAULT GETDATE() NOT NULL                                                                                     --创建时间
)
GO
...
[ID]               UNIQUEIDENTIFIER CONSTRAINT IX_SYS_WeiXin_Config PRIMARY KEY DEFAULT NEWSEQUENTIALID(),
[SN]               BIGINT IDENTITY(1,1),                                                                                                   --自增序列
[MallCode]         VARCHAR(8),                                                                                                             --商城代码
[Domain]           VARCHAR(64),                                                                                                            --业务域名
[Token]            VARCHAR(32),                                                                                                            --Token
[EncodingAESKey]   VARCHAR(64),                                                                                                            --EncodingAESKey
[AppID]            VARCHAR(32),                                                                                                            --应用ID
[AppSecret]        VARCHAR(32),                                                                                                            --应用密钥
[PartnerKey]       VARCHAR(32),                                                                                                            --PartnerKey
[mch_id]           VARCHAR(32),                                                                                                            --商户号
[device_info]      VARCHAR(32),                                                                                                            --设备号
[spbill_create_ip] VARCHAR(16),                                                                                                            --服务器IP
[OpenJSSDK]        VARCHAR(32),                                                                                                            --OpenJSSDK
[CreateTime]       DATETIME DEFAULT GETDATE() NOT NULL                                                                                     --创建时间
)
GO