...
select 'TCP', 'XfbInterface', 'Insight.WS.Service.XinFenBao.Interface', 'Insight.WS.Service.XinFenBao.IInterface', 'Services\\XinFenBao' union all
select 'HTTP', 'XfbInternal', 'Insight.WS.Service.XinFenBao.Internal', 'Insight.WS.Service.XinFenBao.IInternal', 'Services\\XinFenBao' union all
select 'TCP', 'XfbManager', 'Insight.WS.Service.XinFenBao.Manager', 'Insight.WS.Service.XinFenBao.IManager', 'Services\\XinFenBao' union all
