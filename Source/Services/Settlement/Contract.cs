...
namespace Insight.WS.Server.Common.Utils
{
    public partial class DataAccess
    {
        ...
        {
            var pids = SqlHelper.SqlQuery(SqlHelper.MakeCommand($"select * from dbo.Get_FundPlanId('{pid}')"));
        ...
        {
            var pids = SqlHelper.SqlQuery(SqlHelper.MakeCommand($"select * from dbo.Get_GoodsPlanId('{pid}')"));
