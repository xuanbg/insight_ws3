...
namespace Insight.WS.Client.Platform.Base
{
    partial class NodeMove
    {
        ...
        {
            var resources = new System.ComponentModel.ComponentResourceManager(typeof(NodeMove));
