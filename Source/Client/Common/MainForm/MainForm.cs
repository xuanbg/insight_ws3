...
namespace Insight.WS.Client.Common
{
    public partial class MainForm : XtraForm
    {
        ...
        private void MainForm_Shown(object sender, EventArgs e)
        {
            ...
            if (Session.Signature == General.GetHash(Session.LoginName.ToUpper() + General.GetHash("123456")))
        ...
        private void MainForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (!Commons.DelOnlineUser(Session, Session.LoginName) && General.ShowConfirm(str) != DialogResult.OK) e.Cancel = true;
        }
