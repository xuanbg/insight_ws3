...
{
  internal class VbCodeHelper : CodeHelperBase
  {
    ...
    {
      name = name.Replace(" ", "_");
      return "    Public " + name + " as " + type.FullName + "\r\n";
    }

    public override string BeginCalcExpression()
    {
      return "    Private Function CalcExpression(ByVal expression As String, ByVal Value as FastReport.Variant) As Object\r\n      ";
    }
    ...
    public override string GenerateInitializeMethod()
    {
      ...
      {
        result += "AddHandler " + de.Key.ToString() + ", New EventHandler(AddressOf " + 
          de.Value.ToString() + ")\r\n      ";
      }
