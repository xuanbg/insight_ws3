...
namespace FastReport.Table
{
  ...
  class TableObject : TableBase
  {
    ...
    private TableHelper FHelper;
    private bool FSaveVisible;
    private bool FSaveStateSkipped;
    private TableCell FDragCell;
    private bool FManualBuildAutoSpans;
    #endregion
    ...
    {
      get { return FManualBuildAutoSpans; }
      set { FManualBuildAutoSpans = value; }
    }
    ...
    public override void Draw(FRPaintEventArgs e)
    {
      ...
      if (FDragCell != null)
        FDragCell.DrawDragAcceptFrame(e, Color.Silver);
    }
    ...
    {
      FDragCell.Text = (e.DragSource as TextObject).Text;
      FDragCell = null;
    }

    internal override ContextMenuBar GetColumnContextMenu(TableColumn column)
    {
      return new TableColumnMenu(Report.Designer);
    }

    internal override ContextMenuBar GetRowContextMenu(TableRow row)
    {
    ...
    public override void SaveState()
    {
      ...
      FSaveStateSkipped = !Visible || (parent != null && !parent.Visible);
      if (FSaveStateSkipped)
        return;
      ...
      else
      {
        ...
        FHelper = new TableHelper(this, ResultTable);
