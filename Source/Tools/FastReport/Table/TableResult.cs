...
namespace FastReport.Table
{
  ...
  {
    private bool FSkip;
    private List<TableRow> FRowsToSerialize;
    private List<TableColumn> FColumnsToSerialize;
    ...
    {
      get { return FRowsToSerialize; }
    }

    internal List<TableColumn> ColumnsToSerialize
    {
      get { return FColumnsToSerialize; }
    }
    ...
    {
      LockCorrectSpans = true;
      FRowsToSerialize = new List<TableRow>();
      FColumnsToSerialize = new List<TableColumn>();
    }
