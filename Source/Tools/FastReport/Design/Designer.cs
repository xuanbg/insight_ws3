...
namespace FastReport.Design
{
  ...
  public partial class Designer : UserControl, ISupportInitialize
  {
    ...
    private DevComponents.DotNetBar.TabControl FTabs;
    ...
    {
      FTabs.Style = UIStyleUtils.GetTabStripStyle(UIStyle);
    ...
    {
      FTabs = new DevComponents.DotNetBar.TabControl();
    ...
    {
      XmlItem xi = root.FindItem("Designer").FindItem("DockNew");
