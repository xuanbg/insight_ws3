...
namespace FastReport.Engine
{
  ...
  public partial class ReportEngine
  {
    ...
    {
      get { return (FPage.PaperWidth - FPage.LeftMargin - FPage.RightMargin) * Units.Millimeters; }
    }
    ...
    {
      get { return (FPage.PaperHeight - FPage.TopMargin - FPage.BottomMargin) * Units.Millimeters; }
    }
    ...
    internal bool Run(bool runDialogs, bool append)
    {
      return Run(runDialogs, append, null);
    }

    internal bool Run(bool runDialogs, bool append, ReportPage page)
    {
      FDate = DateTime.Now;
      Report.SetOperation(ReportOperation.Running);
      ResetDesigningFlag();
      
      // don't reset the data state if we run the hyperlink's detail page.
