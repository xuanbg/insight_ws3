...
namespace FastReport
{
  ...
  public class Report : Base, IParent, ISupportInitialize
  {
    #region Fields
    ...
    {
      get { return FDictionary.Parameters; }
    }
    ...
    {
      get { return FReportInfo; }
      set { FReportInfo = value; }
    }
    ...
    {
      get { return FConvertNulls; }
      set { FConvertNulls = value; }
    }
    ...
    {
      get { return FDoublePass; }
      set { FDoublePass = value; }
    }
    ...
    {
      get { return FUseFileCache; }
      set { FUseFileCache = value; }
    }
    ...
    {
      get { return FTextQuality; }
      set { FTextQuality = value; }
    }
    ...
    {
      get { return FSmoothGraphics; }
      set { FSmoothGraphics = value; }
    }
    ...
    {
      get { return FAutoFillDataSet; }
      set { FAutoFillDataSet = value; }
    }
    ...
    {
      get { return FReferencedAssemblies; }
      set { FReferencedAssemblies = value; }
    }
    ...
    {
      get { return FStartReportEvent; }
      set { FStartReportEvent = value; }
    }
    ...
    {
      get { return FFinishReportEvent; }
      set { FFinishReportEvent = value; }
    }
    ...
    {
      get { return FStoreInResources; }
      set { FStoreInResources = value; }
    }
    ...
    {
      get { return FScriptRestrictions; }
      set { FScriptRestrictions = value; }
    }
    ...
    {
      get { return FInitialPageNumber; }
      set { FInitialPageNumber = value; }
    }
    ...
    internal void SetPreparedPages(Preview.PreparedPages pages)
    {
    ...
    private bool Design(bool modal, Form mdiParent)
    {
      ...
      if (UIStyleUtils.IsOffice2007Scheme(Config.UIStyle) && Config.UseOffice2007Form)
      {
        FDesignerForm = new Office2007DesignerForm();
        (FDesignerForm as Office2007DesignerForm).Designer.Report = this;
      }  
      else
      {
        FDesignerForm = new DesignerForm();
    ...
    internal bool DesignPreviewPage()
    {
      ...
      Form designerForm = null;
      if (UIStyleUtils.IsOffice2007Scheme(Config.UIStyle) && Config.UseOffice2007Form)
      {
        designerForm = new Office2007DesignerForm();
        FDesigner = (designerForm as Office2007DesignerForm).Designer;
      }
      else
      {
    ...
    internal void PreparePage(ReportPage page)
    {
      SetRunning(true);
      try
      {
        Engine.Run(false, false, page);
      }
      finally
      {
        SetRunning(false);
    ...
    private void ShowPrepared(bool modal, Form mdiParent, IWin32Window owner)
    {
      ...
      {
        if (UIStyleUtils.IsOffice2007Scheme(Config.UIStyle) && Config.UseOffice2007Form)
          FPreviewForm = new Office2007PreviewForm();
        else
        ...
        if (FPreviewForm is Office2007PreviewForm)
          Preview = (FPreviewForm as Office2007PreviewForm).Preview;
        else
