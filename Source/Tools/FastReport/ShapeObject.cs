...
namespace FastReport
{
  ...
  /// </remarks>
  public class ShapeObject : ReportComponentBase, IHasEditor
  {
    #region Fields
    private ShapeKind FShape;
    private float FCurve;
    #endregion
      ...
      switch (Shape)
      {
        ...
        case ShapeKind.RoundRectangle:
          ...
          if (FCurve == 0)
            ...
            min = Math.Min(min, FCurve * e.ScaleX * 10);
