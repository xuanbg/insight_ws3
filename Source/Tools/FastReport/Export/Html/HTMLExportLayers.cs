...
namespace FastReport.Export.Html
{
    ...
    public partial class HTMLExport : ExportBase
    {
        ...
        private string GetStyle(Font Font, Color TextColor, Color FillColor, bool RTL, HorzAlign HAlign, Border Border, bool WordWrap)
        {
        ...
        private int UpdateCSSTable(ReportComponentBase obj)
        {
            ...
            if (obj is TextObject)
            {
                ...
                style = GetStyle(textObj.Font, textObj.TextColor, textObj.FillColor, textObj.RightToLeft, textObj.HorzAlign, textObj.Border, textObj.WordWrap);
            }
            else
                style = GetStyle(null, Color.White, obj.FillColor, false, HorzAlign.Center, obj.Border, false);
