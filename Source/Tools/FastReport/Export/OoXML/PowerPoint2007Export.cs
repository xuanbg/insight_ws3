...
namespace FastReport.Export.OoXML
{
    ...
    internal class PptShape : OoXMLBase
    {
        ...
        internal void ExportFourBorders(StreamWriter Out, int id)
        {
            Border b = FObject.Border;
        ...
        private void Export_Line(StreamWriter Out, ulong x, ulong y, ulong dx, ulong dy, Color LineColor, float width, LineStyle style, int id )
        {
            Out.WriteLine("<p:cxnSp>");
            Out.WriteLine("<p:nvCxnSpPr><p:cNvPr id="+Quoted(id) + " name=\"Straight Connector 61\" /><p:cNvCxnSpPr />");
            Out.WriteLine("<p:nvPr />");
            Out.WriteLine("</p:nvCxnSpPr>");
            Out.WriteLine("<p:spPr>");
        ...
        internal void Export_Shadow(StreamWriter Out, int id)
        { 
            ulong x, y, cx, cy;
    ...
    internal abstract class OoSlideBase : OoXMLBase
    {
        ...
        protected void ExportShape(StreamWriter Out, PptShape shape, string ShapeType, int id)
        {
            bool do_borders;
            Out.WriteLine("<p:sp>");
...
Out.WriteLine("<a:tcPr marL=\"0\" marR=\"0\" marT=\"0\" marB=\"0\" />");
    ...
    public class PowerPoint2007Export : OOExportBase
    {
        ...
        protected override void Start()
        {
            ...
            Directory.CreateDirectory(FTempFolder + "/ppt/theme");
