...
namespace FastReport
{
  ...
  public abstract class ReportComponentBase : ComponentBase
  {
    ...
    /// </remarks>
    [DefaultValue(PrintOn.FirstPage | PrintOn.LastPage | PrintOn.OddPages | PrintOn.EvenPages | PrintOn.RepeatedBand)]
        ...
        Top < 0 || Top > (Parent as ComponentBase).Height)
      {
        if (HasFlag(Flags.CanChangeParent))
        {
          ...
          for (int i = list.Count - 1; i >= 0; i--)
          {
            ...
            {
              bool inside;
              int bandGap = ReportWorkspace.ClassicView ? BandBase.HeaderSize : 4;
              if (c is BandBase)
    ...
    public ReportComponentBase()
    {
      ...
      FEvenStyle = "";
      FHoverStyle = "";
      FPrintOn = PrintOn.FirstPage | PrintOn.LastPage | PrintOn.OddPages | PrintOn.EvenPages | PrintOn.RepeatedBand;
      FBeforePrintEvent = "";
      FAfterPrintEvent = "";
      FAfterDataEvent = "";
      FClickEvent = "";
