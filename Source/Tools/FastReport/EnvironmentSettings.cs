...
namespace FastReport
{
  ...
  public class EnvironmentSettings : Component
  {
    ...
    [SRCategory("UI")]
    [DefaultValue(true)]
    [Description("Indicates whether the Office2007-style window should be used instead of standard Form when Office2007 color scheme is selected.")]
    public bool UseOffice2007Form
    {
      get { return Config.UseOffice2007Form; }
      set { Config.UseOffice2007Form = value; }
    }
